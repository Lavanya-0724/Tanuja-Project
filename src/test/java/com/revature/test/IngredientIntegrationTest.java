...
public class IngredientIntegrationTest {
    ...
    void testGetIngredients() {
        JavalinTest.test(app, (server, client) -> {
            ...
            assertEquals(
                    "[{\"id\":1,\"name\":\"carrot\"},{\"id\":4,\"name\":\"lemon\"},{\"id\":2,\"name\":\"potato\"},{\"id\":5,\"name\":\"rice\"},{\"id\":6,\"name\":\"stone\"},{\"id\":3,\"name\":\"tomato\"}]",
    ...
    void testPageIngredients() {
        JavalinTest.test(app, (server, client) -> {
            ...
            assertEquals(
                    "{\"pageNumber\":1,\"pageSize\":2,\"totalPages\":3,\"totalElements\":6,\"items\":[{\"id\":1,\"name\":\"carrot\"},{\"id\":4,\"name\":\"lemon\"}]}",
    ...
    void testGetIngredientsByTerm() {
        JavalinTest.test(app, (server, client) -> {
            ...
            assertEquals(
                    "[{\"id\":2,\"name\":\"potato\"},{\"id\":6,\"name\":\"stone\"},{\"id\":3,\"name\":\"tomato\"}]",
